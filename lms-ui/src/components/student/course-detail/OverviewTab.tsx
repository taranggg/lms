...
function ProgressCard({ percent, label, value, total }: ProgressCardProps) {
  ...
  return (
    <div className="bg-card rounded-2xl px-4 py-4 md:px-8 md:py-6 shadow-sm border border-border flex flex-col items-center justify-center gap-2 md:gap-3 min-w-0 hover:-translate-y-1 hover:shadow-md transition-all duration-300">
      ...
      <div className="text-[11px] md:text-sm font-semibold text-foreground text-center">
        {label}
      </div>
    ...
    <div className="flex flex-col gap-10 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[minmax(0,2.1fr)_minmax(0,1fr)] gap-6 items-stretch w-full">
        ...
        <div className="flex flex-col h-full">
          <div className="bg-card rounded-3xl px-6 py-6 md:px-8 md:py-7 shadow-sm border border-border flex flex-col md:flex-row gap-6 md:gap-8 items-center h-full hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <div className="flex-1 min-w-0">
              <div className="text-[10px] md:text-[11px] font-semibold text-sky-500 mb-2 tracking-[0.12em] uppercase">
                Next Live Session
              </div>
              <div className="text-xl md:text-[26px] font-bold mb-3 leading-tight text-foreground">
                {nextSessionTitle}
              </div>
              <div className="text-xs md:text-sm text-muted-foreground mb-4 leading-relaxed max-w-xl">
                {nextSessionDescription}
              </div>

              <div className="flex items-center gap-2 text-xs md:text-sm text-muted-foreground mb-5">
                <div className="flex items-center justify-center w-7 h-7 rounded-full bg-sky-50 dark:bg-sky-900/20 text-sky-600 dark:text-sky-400">
                  <svg
                    viewBox="0 0 24 24"
                    className="w-4 h-4"
                    stroke="currentColor"
              ...
              <button className="inline-flex items-center gap-2 px-4 md:px-5 py-2 md:py-2.5 rounded-full bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 font-medium text-xs md:text-sm shadow-sm hover:bg-sky-200 dark:hover:bg-sky-900/50 hover:shadow-md active:translate-y-[1px] transition-all duration-200">
                <span>
                  <svg
                    viewBox="0 0 24 24"
                    className="w-4 h-4"
        ...
        {/* Batch Info Card */}
        <div className="bg-card rounded-3xl px-6 py-6 md:px-8 md:py-7 shadow-sm border border-border flex flex-col gap-4 h-full justify-center hover:-translate-y-1 hover:shadow-md transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[minmax(0,2.1fr)_minmax(0,1fr)] gap-6 items-stretch w-full">
        ...
        {/* Cohort Card */}
        <div className="bg-card rounded-3xl px-6 py-6 md:px-8 md:py-7 shadow-sm border border-border flex flex-col gap-4 md:gap-5 h-full justify-center hover:-translate-y-1 hover:shadow-md transition-all duration-300">
          <h2 className="text-base md:text-lg font-semibold text-foreground">
          ...
          <div className="flex flex-wrap gap-3 md:gap-4">
            {students.slice(0, 11).map((mateId, idx) => (
              <div
                key={mateId ?? idx}
                className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900/30 flex items-center justify-center overflow-hidden shadow-sm hover:scale-105 transition-transform duration-200"
              >
            ...
            {students.length > 11 && (
              <div className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-muted border border-border flex items-center justify-center text-[10px] md:text-xs font-semibold text-muted-foreground hover:scale-105 transition-transform duration-200">
                +{students.length - 11}
              </div>
            )}
          </div>
