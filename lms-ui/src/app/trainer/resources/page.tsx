...
import TrainerResourcesPage from "@/components/trainer/TrainerResourcesPage";
...
export default function TrainerResourcesRoute() {
  ...
  const mobileNavItems: MobileNavItem[] = [
     ...
     { label: "Resources", icon: <BookOpen className="w-5 h-5"/>, active: true, onClick: () => router.push("/trainer/resources") },
